...
SIGNON: defb   "Z80 BASIC Ver 4.7b",CR,LF
...
DEINT:  LD      A,(FPEXP)       ; Get integer value to DE
        CP      128+16          ; Exponent in range (16 bits)?
...
FLGREL: LD      B,128+8         ; 8 bit integer in exponent
...
INVSGN: LD      HL,FPREG+2      ; Point to MSB
        ...
        XOR     128             ; Invert sign of mantissa
...
INT:    LD      HL,FPEXP        ; Point to exponent
        LD      A,(HL)          ; Get exponent
        CP      128+24          ; Integer accuracy only?
        LD      A,(FPREG)       ; Get LSB
        RET     NC              ; Yes - Already integer
        LD      A,(HL)          ; Get exponent
        CALL    FPINT           ; F.P to integer
        LD      (HL),128+24     ; Save 24 bit integer
