...
const double A0 = 1.0; // 2.0; // 0.5; is stronger amplitude than 1.0 // 1.0;
const double kappa = 0.005; // 1.0; // 2.0 * 0.025; // 1.2; // 0.8; //  0.4; // 0.1; // 4.0 * 0.05; // large number to fast time to change
...
const IM GAMMA = 0.03 + I * 0.0; // 0.003 + I * 0.0; // 0.0003 + I * 0.0;
const double GG = 1.0;
const double G0 = 1.0;
const double G1 = 1.0;
