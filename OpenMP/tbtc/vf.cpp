...
// low wavenumber
const double KKL = dkx * 15.5; // 9.5; // 3.5; // 1.5;
const double KKH = dkx * 16.5; // 10.5; // 4.5; // 2.5;
// high wavenumber
//const double KKL = dkx * 63.5;
//const double KKH = dkx * 64.5;
...
#pragma omp parallel for
	...
	fclose(fp);
	printf( "velocity field process Done.\n" );
}
